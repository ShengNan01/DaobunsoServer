...
<head>
    ...
    <link rel="stylesheet" href="./css/service-project1.css">
    <link rel="stylesheet" href="//code.jquery.com/ui/1.10.4/themes/smoothness/jquery-ui.css">
    <script src="//code.jquery.com/jquery-1.9.1.js"></script>
    <script src="//code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
    <link rel="stylesheet" href="http://jqueryui.com/resources/demos/style.css">
    <script src="./Java017_project/js/service-pro1.js"></script>
</head>
<body>
    <header>
        <div id="header_media">
            ...
            <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="10000">
                    <img src="./image/proj1-1.jpg" class="d-block" alt="...">
                  ...
                  <div class="carousel-item" data-bs-interval="2000">
                    <img src="./image/proj1-2.jpg" class="d-block" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                  ...
                  <div class="carousel-item">
                    <img src="./image/proj1-3.jpg" class="d-block" alt="...">
                    <div class="carousel-caption d-none d-md-block">
...
<!-- 旁邊文字 -->
          <div class="col-md-8">
            <div class="card-body">
              <h3 class="fw-bold">單次方案：收取一次垃圾</h3>
              <p class="card-text">適合對象：1-2人  小家庭/ 外宿族群/</p>
              <p class="card-text"><small class="text-muted">到府收取 1 次</small></p>
              <ul class="list-group list-group-flush">
                <li class="list-group-item">>  方案提供每次一個一般垃圾袋/ 一個回收袋/ 一個防臭廚餘袋</li>
                <li class="list-group-item">>  單次最多收取量為：一般垃圾、回收、廚餘 各 1 袋</li>
...
<!-- 旁邊選單 -->
    ...
    <form class="formtest" id="formid" action="">
      <form class="d-flex" id="Datatext" for="mydate">日期選取 Data Selection
        <input id="mydate" class="form-control me-2" name="Data" type="data" placeholder="請選擇日期" aria-label="Data">
            <br>
...
<div class="modal fade" id="myModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <script src="./js/service-pro1.js"></script>
</body>
</html>
