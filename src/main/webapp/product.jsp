  ...
  <nav>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col my-auto">
            ...
            <!-- /btn-group -->
            <!-- <button type="button"class="cart-add btn btn-outline-primary my" >加入購物車
              <a href="./shopping_cart.html"></a>
            </button> -->
            <button class="cart-add btn btn-outline-primary my"  id="Projectbutton2">加入購物車</button>
    ...
    <div id="footerbox">
      ...
      <div id="sec_area_8">
          ...
          <a href="<c:url value='/User terms.jsp' />">服務介紹</a>
          <a href="<c:url value='/problem.jsp' />">使用須知</a>
          <a href="<c:url value='/feedback.jsp' />">常見問題</a>
          <a href="<c:url value='/service.jsp' />">使用回饋</a>
