...
<head>
    ...
    <link rel="stylesheet" href="./css/service-project3.css">
    <link rel="stylesheet" href="//code.jquery.com/ui/1.10.4/themes/smoothness/jquery-ui.css">
    <script src="//code.jquery.com/jquery-1.9.1.js"></script>
    <script src="//code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
    <link rel="stylesheet" href="http://jqueryui.com/resources/demos/style.css">
    <script src="./js/service-pro3.js"></script>
</head>
<body>
    <header>
        <div id="header_media">
            ...
            <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="10000">
                    <img src="./image/pexels-ryutaro-tsukata-5472306 (1).jpg" class="d-block" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                      <h5 class="text1">社區一起丟垃圾</h5>
                      <p class="text1">可以跟自己附近鄰居一起丟垃圾~</p>
                    </div>
                  </div>
                  <div class="carousel-item" data-bs-interval="2000">
                    <img src="./image/pexels-sam-jean-1776952.jpg" class="d-block" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                      <h5 class="text1">社區方案可以多丟一些垃圾</h5>
                      <p class="text1">使用社區方案的客戶垃圾量過多,可以每個人每次在多丟一包一般垃圾</p>
                    </div>
                  </div>
                  <div class="carousel-item">
                    <img src="./image/pexels-mister-mister-3434533.jpg" class="d-block" alt="...">
                    <div class="carousel-caption d-none d-md-block">
...
<!-- 旁邊文字 -->
          <div class="col-md-8">
            <div class="card-body">
              <h3 class="fw-bold">社區服務方案：以一個社區為單位的服務</h3>
              <p class="card-text">適合對象：小型社區/ 大約25-35人/</p>
              <p class="card-text"><small class="text-muted">每周收取 3 次</small></p>
              <ul class="list-group list-group-flush">
                <li class="list-group-item">>  方案提供12個一般垃圾袋/ 6個回收袋/ 12個防臭廚餘袋</li>
                <li class="list-group-item">>  社區訂購方案以一個月30天為基準,30天後重行訂約</li>
