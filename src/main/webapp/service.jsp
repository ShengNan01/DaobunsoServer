    ...
    <section>
        <div class="wrap">
          ...
          <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <a href="./service-project1.html" class="btn btn-primary me-md-2" id="Projectbutton1" type="button">Single Project</a>
           
          </div>
          <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <a href="./service-project2.html" class="btn btn-primary"  id="Projectbutton2" type="button">Month Project</a>
          </div>
            <div class="d-grid gap-2 d-md-flex justify-content-md-end"></div>
            <a href="./service-project3.html" class="btn btn-primary" id="Projectbutton3"  type="button">Community Service Project</a>
          </div>
