...
<body>
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
              <a class="navbar-brand" href="<c:url value='/frontpage.html' />"><img src="./image/LOGO1.png" alt="LOGO" width="120rem"></a>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link" href="<c:url value='/frontpage.html' />">Home</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="<c:url value='/about_us.html' />">About</a> 
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="<c:url value='/shopping.html' />">Shopping</a>                   
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="<c:url value='/service.html' />">Service</a>                   
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="<c:url value='/shopping_cart.html' />">Shopping Cart</a>
                  </li>
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Log In</a>
                    <ul class="dropdown-menu">
                      <li><a class="dropdown-item" href="<c:url value='/profiles.html' />">個人資訊</a></li>
                      <li><a class="dropdown-item" href="<c:url value='/order_main.html' />">訂單管理</a></li>
                      <li><a class="dropdown-item" href="<c:url value='/shopping_cart.html' />">購物車</a></li>
    ...
    <section>
                    ...
                    <div class="col-6 mx-auto">
                        <form method="POST" id="form_in">
                            ...
                            <div class="mb-3 form-check">
                              ...
                              <a href="<c:url value='/forget_password.html' />">忘記密碼?</a>
                            </div>
        ...
        <ul class="nav justify-content-center">
          <li class="nav-item">
            <a class="nav-link" href="<c:url value='/about_us.html' />">關於我們</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<c:url value='/service_intro.html' />">服務介紹</a>            
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<c:url value='/User terms.html' />">使用須知</a>            
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<c:url value='/problem.html' />">常見問題</a>  
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<c:url value='/feedback.html' />">使用回饋</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<c:url value='/service.html' />">購買服務</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<c:url value='/shopping.html' />">購物商城</a>
          </li>
        </ul>
    </section>
    <footer>
