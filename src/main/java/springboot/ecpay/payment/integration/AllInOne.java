package springboot.ecpay.payment.integration;
...
import springboot.ecpay.payment.integration.domain.AioCheckOutCVS;
import springboot.ecpay.payment.integration.domain.AioCheckOutDevide;
import springboot.ecpay.payment.integration.domain.AioCheckOutOneTime;
import springboot.ecpay.payment.integration.domain.AioCheckOutPeriod;
import springboot.ecpay.payment.integration.domain.AioCheckOutWebATM;
import springboot.ecpay.payment.integration.domain.CVSOrBARCODERequestObj;
import springboot.ecpay.payment.integration.domain.CreateServerOrderObj;
import springboot.ecpay.payment.integration.domain.DoActionObj;
import springboot.ecpay.payment.integration.domain.FundingReconDetailObj;
import springboot.ecpay.payment.integration.domain.InvoiceObj;
import springboot.ecpay.payment.integration.domain.QueryCreditCardPeriodInfoObj;
...
import springboot.ecpay.payment.integration.ecpayOperator.EcpayFunction;
...
import springboot.ecpay.payment.integration.verification.VerifyAioCheckOut;
import springboot.ecpay.payment.integration.verification.VerifyCreateServerOrder;
import springboot.ecpay.payment.integration.verification.VerifyDoAction;
import springboot.ecpay.payment.integration.verification.VerifyFundingReconDetail;
import springboot.ecpay.payment.integration.verification.VerifyQueryCreditTrade;
import springboot.ecpay.payment.integration.verification.VerifyQueryTrade;
import springboot.ecpay.payment.integration.verification.VerifyQueryTradeInfo;
import springboot.ecpay.payment.integration.verification.VerifyTradeNoAio;
...
//	
	...
	} //將此htmlcode裝成bean回傳引入controller
}
