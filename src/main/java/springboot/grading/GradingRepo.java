...
public interface GradingRepo extends JpaRepository<Grading, Integer> {
	...
	void updateGradingById(@Param(value = "star") Integer star, @Param(value = "date") String date,
			@Param(value = "comment") String comment, @Param(value = "objectid") Integer objectid);
